...
pub struct IosConfig {
    ...
    pub runtime: String,
    /// BitChat iOS app bundle ID (auto-detected from app if not specified)
    ...
    fn default() -> Self {
        Self {
            ios: IosConfig {
                ...
                // Bundle ID will be auto-detected from built app's Info.plist
                app_bundle_id: "auto-detect".to_string(),
                app_source: "./vendored/bitchat-ios/build/BitChat.app".to_string(),
            ...
            android: AndroidConfig {
                ...
                apk_source: "./vendored/bitchat-android/build/BitChat.apk".to_string(),
